          ...
          <div className="relative w-80 h-80 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 border-4 border-gray-600 shadow-2xl">
            ...
            <div className="absolute inset-2 rounded-full border-2 border-gray-500">
              {Array.from({ length: 72 }, (_, i) => {
                ...
                const length = isMainDirection ? 20 : isMidDirection ? 15 : 8;
                const width = isMainDirection ? 3 : isMidDirection ? 2 : 1;
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      transformOrigin: `center ${152 - length / 2}px`,
                    }}
                  />
                );
              })}
          ...
          {loading && !error && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 max-w-md mx-auto">
                Please allow location access to determine the precise direction
                to Mecca from your current position.
              </p>
            </div>
          )}
