...
const PrayerTimesCard = ({
  ...
  const playAdhan = async (prayerName: string) => {
    try {
      if (audioRef.current) {
        ...
        const audioUrl =
          prayerName === "fajr" ? adhanAudioUrls.fajr : adhanAudioUrls.default;
        ...
        if ("Notification" in window && Notification.permission === "granted") {
          new Notification(`${t(prayerName as any)} Prayer Time`, {
            body: `It's time for ${t(prayerName as any)} prayer`,
      ...
      alert(`${t(prayerName as any)} Prayer Time!`);
    }
  };
  ...
  }, [prayerTimes, isAdhanEnabled, lastPlayedPrayer]);
